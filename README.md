...
--------
To clone the SalesVision_Web_Theme repository, use git clone:

<pre>
 git clone https://github.com/wavemaker/SalesVision_Web_Theme.git
 cd SalesVision_Web_Theme
 npm install
</pre>
...
Build
--------
To build the WaveMaker Theme run the below command from SalesVision_Web_Theme directory
